...
## plots the Global active power in kilowatts over time by day

plot(Final_data$Date_Time, as.numeric(as.character(Final_data$Global_active_power)),
     xlab = "", 
     ylab = "Global Active Power (Kilowatts)", 
     type = 'l')

##recreates the same plot and sends to "plot2" png file
